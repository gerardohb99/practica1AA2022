...
wc -l output.txt > salida-sameMaps-freeHunt.txt
...
wc -l output.txt > salida-sameMaps-sandClockHunt.txt
...
wc -l output.txt > salida-sameMaps-theLMap.txt
...
wc -l output.txt > salida-sameMaps-dotHunt.txt
